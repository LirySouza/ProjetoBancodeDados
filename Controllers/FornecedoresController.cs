...
namespace ProjetoBancodeDados.Controllers
{
    public class FornecedoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeFornecedor,CnpjFornecedor")] Fornecedores fornecedores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeFornecedor,CnpjFornecedor")] Fornecedores fornecedores)
        {
